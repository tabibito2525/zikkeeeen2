...
try {
 ...
 /*ここの部分を変える*/
  $sql = "INSERT INTO puni5 (name, mail, music,index2,checkValue) VALUES (:name, :mail, :music,:index2,:checkValue)"; // テーブルに登録するINSERT INTO文を変数に格納　VALUESはプレースフォルダーで空の値を入れとく
